        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using Document Organiser (&quot;the Service&quot;), you agree to be
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Each account is subject to a storage quota. Files placed in the trash are
              automatically deleted after 30 days. We reserve the right to modify storage limits
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              changes constitutes acceptance of the updated Terms. We will notify you of significant
