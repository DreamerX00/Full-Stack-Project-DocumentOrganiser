        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-1 mt-2">
              <li>
                <strong>Account info:</strong> Name, email address, and profile picture (from Google
                OAuth)
              </li>
              <li>
                <strong>Documents:</strong> Files you upload, including metadata (name, size, type)
              </li>
              <li>
                <strong>Usage data:</strong> Activity logs, storage usage, and feature interactions
              </li>
              <li>
                <strong>Device info:</strong> Browser type, IP address, and operating system
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Your documents are stored securely using AWS S3 with encryption. Access credentials
              are hashed using BCrypt. All API communication is encrypted via HTTPS. We implement
